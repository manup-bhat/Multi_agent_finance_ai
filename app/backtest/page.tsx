            ...
            <div className="card-base p-5">
              <div className="flex items-center gap-2 mb-4">
                ...
                <HelpPopover content={{
                  ...
                  body: "The equity curve shows how ₹1,00,000 invested in the strategy grew over time. The grey line is the benchmark (buy and hold Nifty50 / the instrument). If the strategy's orange line consistently stays above the grey line, it is generating alpha — outperforming passive investing.",
                  level: "beginner",
                  tips: [
                    "Orange line above grey = strategy outperforming buy-and-hold",
                    "Flat or downward sections = strategy is in cash (not invested)",
                    "Sharp drops in orange = trade losses or stop-loss triggers",
                    "Smooth upward curve with shallow drops = ideal equity curve",
                  ],
                  affectsVerdict: "A strategy whose equity curve closely tracks the benchmark provides no alpha — adjust parameters or choose a different regime filter.",
                  source: "BacktestEngine (backtesting/engine.py) — daily-bar level simulation with transaction costs",
                }} />
              </div>
              <div className="h-72">
