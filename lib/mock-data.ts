// ============================================================
// TICKERS — static NSE ticker metadata (not financial data)
// All financial/market data must come from the live API.
// ============================================================
...
export const NSE_TICKERS = [
  ...
  { symbol: "TATASTEEL.NS", name: "Tata Steel Ltd", sector: "Metal" },
